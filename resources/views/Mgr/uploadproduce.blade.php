...
--}}
    ...
    <script type="text/javascript" src="{{asset('mgr/js/up_produce.js')}}"></script>

    <div class="admin-content">
        <div class="admin-content-body">
            <div class="am-cf am-padding am-padding-bottom-0">
                <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">上传楼盘图片</strong> >> {{$result->ib_xmmc.'>>'.$result->im_fwfh}}</div>
            </div>
