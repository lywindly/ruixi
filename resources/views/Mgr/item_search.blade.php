          ...
          <div class="am-form-group">
            ...
            <select data-am-selected="{btnSize: 'sm'}" form="item" name="a_sqbh">
              ...
              @foreach($area_buss as $v)
                <option value="{{$v->a_sqbh}}"@if($v->a_sqbh==$result['0']['a_sqbh']) selected @endif>{{$v->a_sqmc}}</option>
              @endforeach
            </select>
          </div>
        </div>
        ...
        <form class="am-form">
                ...
                <td>
                  ...
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button  class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-copy"></span><a href="{{ url('item/form/'.$v->ib_xmbh) }}">信息</a></button>
          ...
          <div class="am-cf">
            ...
            <div class="am-fr">
              ...
              {{$result->appends(['a_sqbh' =>$result[0]['a_sqbh']])->links()}}
