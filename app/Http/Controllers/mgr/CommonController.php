...
class CommonController extends Controller
{
     ...
     * 基础数据信息数组
     */
    public static $base_xmfj = array('甲级','乙级');
    public static $base_xmlx= array('公寓','商铺','住宅','写字楼','独栋商业','社区商业','商业综合体');
    public static $base_fwys = array('业主','物业','中介');
    public static $base_fwzxzk = array('精装','简装','清水');
    public static $base_fwfdsb = array('家具','空调');
    public static $base_cxlx = array('房号','项目','面积');
...
/*
echo CUtf8_PY::encode('成都市天府广场东御街18号');
echo '<br>';//编码为拼音首字母
echo CUtf8_PY::encode('四川世豪广场司', 'all'); //编码为全拼音*/
